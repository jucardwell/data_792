...
You will not turn in this tutorial. This tutorial is designed as an ungraded contact-time activity that allows you to gain the skills necessary to create maps in this course.

In this tutorial, you will explore more advanced features of the tmap mapping package in R. This tutorial does not cover everything. For much more information on making good maps in tmap, this is a great resource: [Spatial Data Visualization with tmap](https://tmap.geocompx.org/)
...
We will use an NC county boundary and Durham schools data to practice our tmap visualization. As you move through the tutorial, copy and paste the commands into your own .Rmd file.
