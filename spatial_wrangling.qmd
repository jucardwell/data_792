# Tutorial: Spatial Wrangling

You will not turn in this tutorial. This tutorial is designed as an ungraded contact-time activity that allows you to gain the skills necessary to complete HW#3.

Beyond wrangling the structure and attributes of our data (like in the Advanced Tidyverse review), we can also wrangle our spatial features.This involves using spatial relationships to create new variables. After completing these exercises, you should be able to:
...
**Q2: Open up the `sidewalks_by_school` object. What is different about this object compared to the original `durham_sidewalks` object?**
